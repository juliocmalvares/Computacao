...
f = open('resultados_epochs_relu_iris.txt', 'r')
f.readline()
f.readline()
for line in f:
...
f = open('resultados_epochs_sig_iris.txt', 'r')
f.readline()
f.readline()
for line in f:
...
f = open('resultados_epochs_tanh_iris.txt', 'r')
f.readline()
f.readline()
for line in f:
...
f = open('resultados_epochs_deg_iris.txt', 'r')
f.readline()
f.readline()
for line in f:
...
plt.legend()
plt.savefig("activation_epochs_iris.png")
...
f = open('resultados_threshold_sig_iris.txt', 'r')
f.readline()
f.readline()
for line in f:
...
f = open('resultados_threshold_tanh_iris.txt', 'r')
f.readline()
f.readline()
for line in f:
...
f = open('resultados_threshold_deg_iris.txt', 'r')
f.readline()
f.readline()
for line in f:
...
f = open('resultados_threshold_relu_iris.txt', 'r')
f.readline()
f.readline()
for line in f:
...
plt.legend()
plt.savefig("activation_thresold_iris.png")
